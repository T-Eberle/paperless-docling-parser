...
- This mode has access to browser automation and MCP server tools
- Use browser for testing web interfaces or documentation
- Use MCP tools for extended functionality beyond standard Python tools